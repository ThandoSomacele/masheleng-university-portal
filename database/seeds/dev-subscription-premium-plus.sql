...
-- Use this to reset to full access after testing upgrades
-- =====================================================
...
BEGIN
  ...
  IF NOT FOUND THEN
    INSERT INTO user_subscriptions (
      ...
      uuid_generate_v4(), demo_user_id, premium_plus_tier_id, 'active',
      NOW() - INTERVAL '15 days', NOW() + INTERVAL '15 days',
      NOW() + INTERVAL '15 days', 'monthly', 'BWP', 250.00,
      0, 4, true, NOW(), NOW()
    );
  END IF;

  RAISE NOTICE 'Demo user subscription set to PREMIUM+ tier (BWP 250.00/month)';
END $$;
